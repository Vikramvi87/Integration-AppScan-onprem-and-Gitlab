...
write-output "pase $CI_PROJECT_DIR\$aseAppName-$CI_JOB_ID.ozasmt -aseapplication $aseAppName -name $aseAppName-$scanname-$CI_JOB_ID" >> scriptpase.scan
write-output "exit" >> scriptpase.scan  

# Executing the script
AppScanSrcCli scr scriptpase.scan
# Getting and writing the scanName in a file
$scanName="$aseAppName-$scanname`-$CI_JOB_ID"
